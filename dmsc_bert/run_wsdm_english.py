...
def main():
    ...
    parser.add_argument('--cached_train_examples', type=str,
                            default=base_dir + '/dmsc/input/cached_train_examples.dat')
    parser.add_argument('--cached_train_features', type=str,
                            default=base_dir + '/dmsc/input/cached_train_features.dat')

    parser.add_argument('--cached_dev_examples', type=str, default=base_dir + '/wsdm/input/cached_dev_examples.dat')
    parser.add_argument('--cached_dev_features', type=str, default=base_dir + '/wsdm/input/cached_dev_features.dat')
    parser.add_argument('--cached_test_examples', type=str, default=base_dir + '/wsdm/input/cached_test_examples.dat')
    parser.add_argument('--cached_test_features', type=str, default=base_dir + '/wsdm/input/cached_test_features.dat')
